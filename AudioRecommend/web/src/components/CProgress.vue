<template>
  <div class="c-progress">
    ...
    <span v-if="showPerText">{{ Math.round(tempPercent) }}%</span>
  </div>
</template>
...
.c-progress .c-progress-outer .c-progress-inner {
  width: 100px;
  height: 10px;
  background: #409eff;
  border-radius: 5px;
...
.c-progress .c-progress-outer .c-progress-slider {
  width: 20px;
  height: 20px;
  border-radius: 50%;
  background: #fff;
